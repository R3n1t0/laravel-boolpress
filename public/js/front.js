...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      apiUrl: _data_config__WEBPACK_IMPORTED_MODULE_2__["apiUrl"],
      posts: [],
      pagination: {
        current: null,
        last: null
...
var render = function render() {
  ...
  }, [_c("h1", [_vm._v("Elenco dei post")]), _vm._v(" "), _vm.posts.length == 0 ? _c("div", [_c("LoaderComp")], 1) : _vm._e(), _vm._v(" "), _vm.posts.length > 0 ? _c("div", _vm._l(_vm.posts, function (post) {
    return _c("PostItem", {
      key: post.id,
      attrs: {
        post: post
